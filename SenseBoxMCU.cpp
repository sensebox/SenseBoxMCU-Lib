...
WiFiBee::WiFiBee(char *ssid, char *password)
{
	nwid = ssid;
	pw = password;
}

bool WiFiBee::connect()
{
...
char *WiFiBee::getSsid()
{
	return this->nwid;
}

char *WiFiBee::getPassword()
{
	return this->pw;
}

WiFiClient *WiFiBee::getClient()
{
	return new WiFiClient;
}

GSMBee::GSMBee(char *pin, char *apn, char *login, char *password)
{
	this->pin = pin;
	this->apn = apn;
	this->login = login;
